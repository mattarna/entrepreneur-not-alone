...
export default function Impact() {
  return (
    <section className="relative bg-white overflow-hidden">
      ...
      {/* Stats Grid */}
      <div className="px-6 md:px-12 lg:px-20 py-20 border-y border-black/5">
        <div className="max-w-[1400px] mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-4">
            {stats.map((stat, index) => (
              ...
              >
                <div className="text-[4rem] md:text-[5rem] lg:text-[6rem] font-light leading-none tracking-tighter text-black/90 group-hover:text-[#5EEAD4] transition-colors duration-500 font-mono">
