  ...
  return (
    ...
    >
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 z-1 bg-white/40 backdrop-blur-[8px]" />
        <div className="absolute inset-0 z-1 bg-gradient-to-b from-white via-transparent to-white/90" />
          ...
          <div className="max-w-[1400px] mx-auto w-full text-center flex flex-col items-center">
            ...
            <div className="mb-14">
              <motion.h2 
                ...
                className="text-[2.5rem] md:text-[5rem] lg:text-[6.5rem] font-medium leading-[0.95] tracking-[-0.04em] text-black mb-8"
              >
              ...
              >
                <p className="text-xl md:text-3xl lg:text-4xl font-light leading-[1.2] tracking-tight text-black/80">
                  We step in when things feel stuck.
                  <br />
                  <span className="text-[#14B8A6] font-medium">and help you regain clarity, direction, and breathing room.</span>
                </p>
              </motion.div>
            </div>
            ...
            <motion.div 
              ...
              className="mb-16"
            >
              <p className="text-lg md:text-xl font-light text-black/40 tracking-tight italic flex flex-wrap justify-center gap-x-6 gap-y-2">
            ...
            <motion.div
              ...
              className="relative w-32 h-32 md:w-40 md:h-40 mix-blend-multiply opacity-90"
            >
              <Image
