      ...
      <div className="max-w-[1100px] mx-auto">
        ...
        >
          ...
          <div className="space-y-10">
            <p className="text-2xl md:text-3xl lg:text-4xl text-black font-medium leading-[1.3] tracking-tight max-w-4xl mx-auto">
              Your contribution doesn't fund an idea.
              <br />
              <span className="text-[#14B8A6]">It gives time, clarity, and human guidance to someone who needs it right now.</span>
            </p>

            <p className="text-xl md:text-2xl lg:text-3xl text-black/80 font-medium leading-relaxed max-w-3xl mx-auto">
