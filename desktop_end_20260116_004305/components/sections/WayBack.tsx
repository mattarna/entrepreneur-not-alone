          ...
          <div className="max-w-[1400px] mx-auto w-full text-center flex flex-col items-center">
            ...
            <div className="mb-14">
              <motion.h2 
                ...
                className="text-[2.5rem] md:text-[5rem] lg:text-[7.5rem] font-medium leading-[0.9] tracking-[-0.03em] text-black mb-8 font-serif"
              >
              ...
              >
                <p className="text-xl md:text-3xl lg:text-4xl font-light leading-[1.2] tracking-tight text-black/90 font-serif italic">
