...
export default function Reinforcement() {
  return (
    <section className="relative min-h-[55vh] md:min-h-[80vh] w-full flex flex-col items-center justify-center py-14 md:py-32 overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto w-full px-4 md:px-6 text-center">
        ...
        >
          ...
          <div className="pt-6 md:pt-10">
            <a 
              href="#donate"
              className="inline-flex items-center gap-3 bg-black hover:bg-black/90 text-white px-6 md:px-10 py-3.5 md:py-5 rounded-full font-bold text-sm tracking-wide transition-all active:scale-[0.98] shadow-2xl font-sans"
            >
