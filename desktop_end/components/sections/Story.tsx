      ...
      <div className="max-w-[1400px] mx-auto w-full grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12">
        ...
        <div className="md:col-span-7 md:col-start-6 space-y-16">
          ...
          <motion.div style={{ opacity: text1Opacity }}>
            <h2 className="text-[1.5rem] md:text-[2rem] lg:text-[2.25rem] font-medium leading-[1.4] tracking-tight text-black font-serif">
          ...
          <motion.div style={{ opacity: text2Opacity }}>
            <p className="text-[1.5rem] md:text-[2rem] lg:text-[2.25rem] font-medium leading-[1.4] tracking-tight text-black font-serif">
          ...
          <motion.div style={{ opacity: text4Opacity }}>
            <p className="text-[1.5rem] md:text-[2rem] lg:text-[2.25rem] font-medium leading-[1.4] tracking-tight text-black border-t border-black/5 pt-12 font-serif italic">
